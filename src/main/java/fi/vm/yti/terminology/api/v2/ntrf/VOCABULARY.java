...
public class VOCABULARY {
     ...
     * This is why there is not a {@code set} method for the recordAndHEADAndDIAG property.
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the recordAndHEADAndDIAG property.
     */
    public List<Object> getRECORDAndHEADAndDIAG() {
        if (recordAndHEADAndDIAG == null) {
            recordAndHEADAndDIAG = new ArrayList<>();
        }
