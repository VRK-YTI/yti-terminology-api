...
public class RequestsController {
    ...
    @Operation(summary = "Request authorization for a organization", description = "Request to be added to an organization in requested role")
    @ApiResponse(responseCode = "200", description = "Request submitted successfully")
    @ApiResponse(responseCode = "401", description = "If the caller is not authenticated user")
