...
public class Helpers {
    public static void assertExcelCellHasValue(Sheet sheet, int rowIndex, int columnIndex, String value) {
    ...
    public static void assertDTOHasValue(SheetDTO dto, String columnName, String lang, int rowNumber, String value) {
